...
const HostRentingRoomDetails = () => {
  ...
  const handleFlatDescriptionChange = (event) =>
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8080/UpdateFlatDetails",
        formData
      );
      console.log(response.data);
      console.log(amenitiesResponse.data);
      navigate(
        "/HostRentingFlatLocation?hostId=" + hostId + "&rentalId=" + rentalId
      );
    } catch (error) {
        ...
        <section className="clean-block clean-form dark">
          <div className="container">
            <div className="block-heading">
              ...
              <p>
                Your flat's location is not the only decisive feature for
                customers. Common areas as well as features of the flat are
                important. Be catchy!
              </p>
            </div>
            <form
              ...
              <div>
                ...
                <div>
                  ...
                  <textarea
                    className="form-control"
                    value={description}
                    onChange={handleFlatDescriptionChange}
                  />
                </div>
