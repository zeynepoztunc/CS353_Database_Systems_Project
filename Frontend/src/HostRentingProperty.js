...
const HostRentingProperty = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (selectedOption === "formCheck-1") {
        navigate(
          `/HostRentingRoomDetails?hostId=${hostId}&rentalId=${rentalId}`
        );
      }
      if (selectedOption === "formCheck-2") {
        navigate(
          `/HostRentingFlatDetails?hostId=${hostId}&rentalId=${rentalId}`
        );
      }
    } catch (err) {
      console.error(err);
        ...
        <section className="clean-block clean-form dark">
          <div className="container">
            <div className="block-heading">
              ...
              <p>
                We simply ask you a few questions about your property. What
                could you do in three minutes? You can boil an egg or become a
                host at WeRent!
              </p>
            </div>
            <form
            ...
            >
              ...
              >
                <input
                  ...
                  type="radio"
                  id="formCheck-1"
                  checked={selectedOption === "formCheck-1"}
              ...
              <div
                ...
                style={{
                  background:
                    'url("./assets/img/6676508.png") right / contain no-repeat',
                  position: "relative",
                  display: "flex",
                  textAlign: "right",
                  height: 68,
              ...
              >
                <input
                  ...
                  type="radio"
                  id="formCheck-2"
                  checked={selectedOption === "formCheck-2"}
                  onChange={handleChange}
                />
                <label
                  className="form-check-label"
