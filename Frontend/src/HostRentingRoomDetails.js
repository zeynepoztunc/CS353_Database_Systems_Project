...
const HostRentingRoomDetails = () => {
  ...
  const handleEarthquakeSupportChange = (event) =>
    setEarthquakeSupport(event.target.checked);
  const handleCouchsurfingChange = (event) =>
    setCouchsurfing(event.target.checked);
  ...
  const handleSubmit = async (event) => {
    ...
    const amenitiesData = {
      ...
      amenities: amenities.map((amenity) => {
        const amenityData = {};
        amenityData[amenity.toString().toLowerCase().replace(" ", "")] =
          selectedItems.includes(amenity) ? 1 : 0;
        return amenityData;
      }),
    };
    ...
    try {
      ...
      const amenitiesResponse = await axios.post(
        "http://localhost:8080/updateRoomDetails/amenities",
        amenitiesData
      );
      const response = await axios.post(
        "http://localhost:8080/updateRoomDetails",
        formData
      );
      console.log(response.data);
      console.log(amenitiesResponse.data);
      navigate(
        "/HostRentingRoomLocation?hostId=" + hostId + "&rentalId=" + rentalId
      );
    } catch (error) {
  ...
  return (
    <>
      ...
      <link
        rel="stylesheet"
        href="./assets/Bootstrap-4-Calendar-No-Custom-Code.css"
      />
      ...
      <link
        rel="stylesheet"
        href="./assets/Button-modal-ecommerce-bs4_modal.min.css"
      />
      <link
        rel="stylesheet"
        href="./assets/Button-modal-ecommerce-styles.css"
      />
      <link rel="stylesheet" href="./assets/Hover-Button-1.css" />
      <link
        rel="stylesheet"
        href="./assets/bootstrap/css/bootstrap.min-1.css"
      />
        ...
        <section className="clean-block clean-form dark">
          <div className="container">
            <div className="block-heading">
              ...
              <p>
                Your room's location is not the only decisive feature for
                customers. Common areas as well as features of the room are
                important. Be catchy!
              </p>
            </div>
            <form
            ...
            >
              ...
              <div>
                  ...
                  <div>
                    <div>
                      ...
                      <label className="form-label">
                        <span style={{ color: "var(--bs-body-bg)" }}>Text</span>
                      ...
                      <label className="form-label">
                        <span style={{ color: "var(--bs-body-bg)" }}>Text</span>
                        For someone, no child = tranquilty.
                      </label>
                      <div className="form-check">
                        <input
                          className="form-check-input"
                ...
                <label className="form-label">
                  <span style={{ color: "var(--bs-body-bg)" }}>Text</span>Pets
                  are our best friends, but some people can be allergic to them.
                </label>
                <div />
                <div>
                  <label className="form-label" style={{ fontWeight: "bold" }}>
                ...
                <div>
                  ...
                  <label className="form-label">
                    Millions of earthquake victims in Turkey are now homeless.
                    You can rent your room to them free!
                  </label>
                  <span className="text-white-50">Text</span>
